...
#define GpioInit(u, v, w, x, y, z)          GpioMcuInit(u, v, w, x, y, z)
#define GpioSetInterrupt(w, x, y, z)        GpioMcuSetInterrupt(w, x, y, z)
#define GpioRemoveInterrupt(x) 
#define GpioWrite(x, y)                     GpioMcuWrite(x, y)
#define GpioRead(x)                         GpioMcuRead(x)
